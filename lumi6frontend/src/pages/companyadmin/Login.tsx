...
export default function CompanyAdminLogin() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await axios.post(`${authConfig.apiUrl}/api/companyadmin/login`, { email, password });
      ...
      if (!authConfig.hasRole('companyadmin')) {
        throw new Error('Invalid user role for company admin login');
      }
