          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <h3 className={designTokens.typography.heading4}>
                Writing Test Created Successfully!
              </h3>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <a
                      ...
                      className={cn(
                        ...
                        'text-orange-600 hover:text-orange-800 flex items-center gap-1 max-w-xs break-all'
                      )}
                    >
                      {result.testLink}
            ...
            <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
              ...
              <div className={cn(designTokens.typography.captionSmall, 'text-orange-700 space-y-1')}>
                ...
                <p>• Complete all writing prompts thoroughly</p>
                <p>• Review your responses before submitting</p>
                <p>• Test will be automatically saved and scored</p>
              </div>
            </div>
