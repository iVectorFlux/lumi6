            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-xs font-bold">Speaking Test</TableHead>
                  <TableHead className="text-xs font-bold">Proficiency Test</TableHead>
                  <TableHead className="text-xs font-bold">Writing Test</TableHead>
                  <TableHead className="text-xs font-bold">EQ Test</TableHead>
            ...
            <TableBody>
              {filteredCandidates.length === 0 ? (
                ...
                filteredCandidates.map((candidate) => {
                  ...
                  const progressPercentage = Math.round((completedTests / 4) * 100);
